...
<ScrollContainer>
  <div>
    ...
    <h4>New</h4>
    <ul>
      <li>New overall app design, with dark mode.</li>
      <li>Much faster page loads, and improved app performance.</li>
      <li>New developer tools, that allow you to run SQL against transit data in the browser.</li>
